...
const createDice = (initialState = {}) => ({
  ...{
    ...
    // Rare
    Rare_D1: { id: 'rare', sides: 1, multiplier: 1.75 },
    Rare_D2: { id: 'rare', sides: 2, multiplier: 1.75 },
    Rare_D3: { id: 'rare', sides: 3, multiplier: 1.75 },
    Rare_D4: { id: 'rare', sides: 4, multiplier: 1.75 },
    Rare_D5: { id: 'rare', sides: 5, multiplier: 1.75 },
    Rare_D6: { id: 'rare', sides: 6, multiplier: 1.75 },
