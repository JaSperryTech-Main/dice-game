...
const DisplayBar = () => {
  ...
  return (
    <aside className="w-[33vw] h-screen border border-black p-5 box-border bg-[#f8f8f8] flex flex-col text-center">
      ...
      {activePage === 'upgrades' && (
        <div className="flex flex-col overflow-x-hidden md:overflow-x-scroll">
                ...
                {Object.entries(upgradesState)
                  ...
                  .map(([upgradeId, count]) => {
                    ...
                    return (
                      <div
                        key={upgradeId}
                        className="flex-shrink-0 w-[calc(33.33%-1rem)] sm:w-[calc(25%-1rem)] md:w-[calc(20%-1rem)]"
                      >
                        <div className="flex flex-col items-center p-4 bg-gray-100 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300">
                          <img
                            src={upgrade.image}
                            alt={upgrade.title}
                ...
                return (
                  ...
                  >
                    ...
                    <button
                      ...
                      className={`col-start-2 row-start-2 self-end justify-self-end bg-blue-500 text-white px-4 py-2 rounded-lg shadow-md hover:bg-blue-600 transition-all duration-200 ${
      ...
      {activePage === 'packs' && (
        <div className="h-full overflow-y-auto flex flex-col gap-4 p-2 border rounded">
